  ...
  return (
   ...
   <div className=' w-full py-3 my-3 border-b border-neutral-200  '>
          <div className=" max-w-[1200px] mx-auto   grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className=" relative h-63 w-94 mx-auto rounded  my-5 group hover: duration-200">
            ...
            <div className=" relative h-63 w-94 rounded mx-auto my-5 group hover: duration-200">
              <div className="absolute h-full w-full overflow-hidden">
